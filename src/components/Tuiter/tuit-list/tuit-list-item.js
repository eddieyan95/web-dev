...
//                              src={tuits.avatarIcon} />
//                     </div>
//
//
//
//                     <div className="col-11">
//                         <h7>{tuits.userName} <i className="fa-solid fa-circle-check"></i></h7>
...
//                             <div>
//                                 <img className="img-fluid image" src={tuits.postPhoto}/>
//                                 <div className="mt-3 border-top:solid grey">
//                                     <h7 className="ps-lg-3">{tuits.textTitle}</h7>
//
//                                     <p className="ps-lg-3">{tuits.textContent} </p>
//                                 </div>
//
//                             </div>
//
...
//                                                        href="#"><i
//                                 className="fa-solid fa-comment"></i> {tuits.comment}</a></div>
//                             <div className="col-3 "><a className="linkcolor text-decoration-none"
//                                                        href="#"><i
//                                 className="fa-solid fa-retweet"></i> {tuits.retweet}</a></div>
//                             <div className="col-3"><a className="heartcolor text-decoration-none"
//                                                       href="#"><i
//                                 className="fa-solid fa-heart"></i> {tuits.like}</a></div>
//                             <div className="col-3"><a className="linkcolor text-decoration-none"
//                                                       href="#"><i
